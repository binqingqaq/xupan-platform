...
`xupan-platform` 是一个正在建立中的平台项目。当前仓库只有后端基础工程，业务范围和首期功能仍待确认。
...
- 当前已具备：Spring Boot 启动类、基础上下文测试、Actuator/Security/WebMVC/Flyway 依赖
- 当前尚未具备：业务接口、领域模型、数据库迁移脚本、前端和生产部署配置
